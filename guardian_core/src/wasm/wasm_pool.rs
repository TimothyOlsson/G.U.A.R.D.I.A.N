//! Source alexcrichton (Alex Crichton)
...
impl WorkerPool {
        ...
        let pool = WorkerPool {
            state: Rc::new(PoolState {
                ...
                callback: Closure::wrap(Box::new(|event: Event| {
                    info!("unhandled event: {}", event.type_());
                    logv(&event);
    ...
    fn spawn(&self) -> Result<Worker, JsValue> {
        ...
        let worker = Worker::new_with_options("./resources/worker.js", &worker_options)?;
